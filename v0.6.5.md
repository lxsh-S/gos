...
If you are a reviewer or are here to vote for this project please do not refer to `README.md` as it has been updated for later version of Gos`v0.8.1` although I have moved the new part to `FolderStructure.md`. This may feel a bit more easier :)
